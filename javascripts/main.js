...
const viewSource = () =>{
    window.location.href = 'https://github.com/Tanmay-Tiwaricyber/realtime-chat-app';
}

const bugReport = () =>{
    window.location.href = `https://github.com/Tanmay-Tiwaricyber/world-chatapp/issues/new?labels=bug&title=New+bug&body=Describe+the+problem`
}
